...
export const siteContent = {
  en: {
    meta: {
      title: "Rogers Vizcaino - Product Engineer / Senior Web Engineer"
    },
    labels: {
    ...
    highlights: [
      {
        value: "14K+",
        label: "monthly users reached by a production web platform"
      },
      {
        value: "550K+",
        label: "monthly impressions from SEO-first architecture"
      },
      {
        value: "AI",
        label: "used for implementation, workflows, and rapid iteration"
      },
      {
        value: "Full ownership",
        label: "product, frontend, integrations, and deployment"
      }
    ],
    stack: [
      {
    ...
    experience: [
      {
        period: "2026 - Present",
        title: "Founder / Senior Web Engineer",
        company: "PromptsMaestros.com",
        description:
          "Built and scaled a production web platform using Astro and modern frontend practices. Grew organic traffic from 0 to 14,000+ monthly users and 550,000+ impressions by designing SEO-first architecture with indexing, canonicalization, crawl control, and performance-focused delivery.\n\nImplemented Core Web Vitals improvements and CLS fixes, built AI-powered features with structured workflows and prompt systems, and used AI tooling to speed up implementation and iteration. Operated as full owner across product, frontend, backend integrations, and deployment.\n\nHighlight: Scaled a product from zero to meaningful search traffic, while keeping the system fast, maintainable, and conversion-oriented.",
        tags: [
          "Astro",
  ...
  es: {
    meta: {
      title: "Rogers Vizcaino - Ingeniero de Producto / Ingeniero Web Senior"
    },
    labels: {
    ...
    highlights: [
      {
        value: "14K+",
        label: "usuarios mensuales alcanzados por una plataforma web en producción"
      },
      {
        value: "550K+",
        label: "impresiones mensuales desde una arquitectura SEO-first"
      },
      {
        value: "IA",
        label: "usada para implementación, workflows e iteración rápida"
      },
      {
        value: "Control total",
        label: "producto, frontend, integraciones y despliegue"
      }
    ],
    stack: [
      {
    ...
    experience: [
      {
        ...
        company: "PromptsMaestros.com",
        description:
          "Construí y escalé una plataforma web en producción usando Astro y prácticas modernas de frontend. Hice crecer el tráfico orgánico de 0 a 14,000+ usuarios mensuales y 550,000+ impresiones, diseñando una arquitectura SEO-first con indexación, canonicalización, control de crawl y delivery enfocado en performance.\n\nImplementé mejoras de Core Web Vitals y CLS, construí funcionalidades impulsadas por IA con workflows estructurados y sistemas de prompts, y usé tooling de IA para acelerar implementación e iteración. Operé como owner total de producto, frontend, integraciones backend y despliegue.\n\nHighlight: Escalé un producto desde cero hasta tráfico real de búsqueda, manteniendo el sistema rápido, mantenible y orientado a conversión.",
        tags: [
          "Astro",
    ...
    languages: [
      ...
      { name: "Inglés", level: "Dominio profesional de trabajo (B2+)" }
    ]
  }
} as const;
